...
// Lightweight Run indicator rectangle used in the layout playground and plugin.
...
// - static draw helper available so callers can paint the indicator without
//   adding it as a persistent child component (useful for z-order control)
